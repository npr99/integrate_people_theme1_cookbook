...
export GIT_REPO_URL="https://github.com/npr99/integrate_people_theme1_cookbook.git"
export COOKBOOK_NAME="integrate_people_sites"
export COOKBOOK_CONDA_ENV="ip1"
IS_GPU_JOB=false
